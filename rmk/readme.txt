...
How to play:
	First, you need to pick a Class:
		chooseclass 'class'
	Use lowercase.
	Classes are:
		Cowboy (Double dex and luck, Classweapon is nailgun)
		Ranger (Double perception and agility, Classweapon is machinegun)
		Deadeye (Double perception and dex, Classweapon is railgun)
		Vanguard (Double agility and endurance, Classweapon is shotgun)
		Juggernaut (Double vitality and endurance, Classweapon is rocket launcher)
	...
	The stats are as follows:
		...
		Luck - Increases Chance to:
			...
			Take No Damage.
			Deal Double Damage.
	You can spawn your 'Class Weapon' by typing it in console, but it costs 50 Experience:
		getclassweapon
	It gives you the weapon if you don't have it, and also gives you ammo. You can buy ammo for your class weapon this way.
